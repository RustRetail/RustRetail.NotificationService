...
{
    internal class EmailNotificationCreatedDomainEventHandler(
        IMessageBus messageBus,
        INotificationUnitOfWork unitOfWork)
        : IDomainEventHandler<DomainEventNotification<EmailNotificationCreatedDomainEvent>>
    {
        ...
        public async Task Handle(
            DomainEventNotification<EmailNotificationCreatedDomainEvent> notification,
            CancellationToken cancellationToken)
        {
            ...
            var renderedBody = template.RenderBody(userContact);
